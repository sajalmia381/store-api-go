...
```shell
mongodump -db=store-api-go --uri=storerestapi.com --port=27017 --username=<USERNAME> --password=hello123 --authenticationDatabase=admin --out=/opt/backup/mongodump-2022-11-18
